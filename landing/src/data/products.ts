      ...
      sampleResult: `// WebCrypto: Signature Verified (HS256)
{
  ...
  "status": "Token Active (Expires in 10+ yrs)"
    ...
    downloads: {
      macArmUrl: 'https://github.com/rjnarwal/tokenlens/releases/download/v1.0.0/TokenLens-1.0.0-arm64.dmg',
      macIntelUrl: 'https://github.com/rjnarwal/tokenlens/releases/download/v1.0.0/TokenLens-1.0.0.dmg',
      winUrl: 'https://github.com/rjnarwal/tokenlens/releases/download/v1.0.0/TokenLens.Setup.1.0.0.exe',
      linuxUrl: 'https://github.com/rjnarwal/tokenlens/releases/download/v1.0.0/TokenLens-1.0.0.AppImage',
...
+ seats: 5`,
    ...
    downloads: {
      macArmUrl: 'https://github.com/rjnarwal/jsonlens/releases/download/v1.0.0/JSONLens-1.0.0-arm64.dmg',
      macIntelUrl: 'https://github.com/rjnarwal/jsonlens/releases/download/v1.0.0/JSONLens-1.0.0.dmg',
      winUrl: 'https://github.com/rjnarwal/jsonlens/releases/download/v1.0.0/JSONLens.Setup.1.0.0.exe',
      linuxUrl: 'https://github.com/rjnarwal/jsonlens/releases/download/v1.0.0/JSONLens-1.0.0.AppImage',
...
• Group 2: "grassroot.digital"`,
    ...
    downloads: {
      macArmUrl: 'https://github.com/rjnarwal/regexforge/releases/download/v1.0.0/RegexForge-1.0.0-arm64.dmg',
      macIntelUrl: 'https://github.com/rjnarwal/regexforge/releases/download/v1.0.0/RegexForge-1.0.0.dmg',
      winUrl: 'https://github.com/rjnarwal/regexforge/releases/download/v1.0.0/RegexForge.Setup.1.0.0.exe',
      linuxUrl: 'https://github.com/rjnarwal/regexforge/releases/download/v1.0.0/RegexForge-1.0.0.AppImage',
...
Base64:  R3Jhc3Nyb290IERpZ2l0YWwgLSBMb2NhbCBGaXJzdA==`,
    ...
    downloads: {
      macArmUrl: 'https://github.com/rjnarwal/cipherlab/releases/download/v1.0.0/CipherLab-1.0.0-arm64.dmg',
      macIntelUrl: 'https://github.com/rjnarwal/cipherlab/releases/download/v1.0.0/CipherLab-1.0.0.dmg',
      winUrl: 'https://github.com/rjnarwal/cipherlab/releases/download/v1.0.0/CipherLab.Setup.1.0.0.exe',
      linuxUrl: 'https://github.com/rjnarwal/cipherlab/releases/download/v1.0.0/CipherLab-1.0.0.AppImage',
